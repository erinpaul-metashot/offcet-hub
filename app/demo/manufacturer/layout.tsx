...
const navItems: NavItem[] = [
  ...
  { label: "Record a batch", href: "/demo/manufacturer/batches/new", icon: "new_batch", group: "Inventory" },
  { label: "Import", href: "/demo/manufacturer/batches/import", icon: "imports", group: "Inventory" },
