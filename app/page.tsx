...
export default function Home() {
  return (
    <main className="w-full h-screen overflow-y-auto snap-y snap-mandatory bg-charcoal text-pure-white overflow-x-hidden">

      {/* SECTION 1: HERO */}
      <section className="relative w-full h-screen flex flex-col snap-start overflow-hidden bg-charcoal">

        {/* Top Charcoal Section (85%) */}
        <div className="h-[85vh] relative w-full px-8 md:px-12 lg:px-16 pt-8 pb-12 md:pb-16 lg:pb-20 flex flex-col justify-end">
          ...
          <div className="absolute top-8 right-8 md:top-12 md:right-12 lg:top-16 lg:right-16 w-24 md:w-32 lg:w-40 aspect-square">
            <Image src="/cirka-c-logo-white white.png" alt="Cirka Mark" fill className="object-cover object-center" />
          </div>

          {/* Main Content (Left Aligned) */}
          <div className="relative z-10 w-full lg:pl-12 pr-8 mt-auto">
            {/* Huge CIRKA Logo (Cropped via aspect ratio) */}
            <div className="relative w-full max-w-[85vw] md:max-w-[65vw] lg:max-w-[55vw] xl:max-w-[45vw] aspect-[3/1] lg:aspect-[10/3] mb-2 md:mb-6">
              <Image src="/cirka-logo-white.png" alt="CIRKA" fill className="object-cover object-left" />
            </div>

            {/* Subtitle 1 */}
            <h1 className="text-[3.5vw] md:text-[2.2vw] lg:text-[1.8vw] xl:text-[1.4vw] whitespace-nowrap max-w-none font-bold uppercase text-pure-white mb-4 md:mb-6 tracking-wide">
      ...
      {/* SECTION 2: THE GAP */}
      <section className="relative w-full h-screen snap-start flex flex-col justify-between overflow-hidden bg-pure-white">
        ...
        <div className="bg-charcoal text-pure-white py-10 md:py-12 lg:py-16 px-4 md:px-12 lg:px-16 flex flex-col items-center justify-center relative z-10 w-full shrink-0 shadow-[0_10px_30px_rgba(0,0,0,0.3)]">
          <h2 className="text-3xl md:text-4xl font-bold uppercase mb-10 md:mb-12 text-center max-w-6xl tracking-wide whitespace-nowrap">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-[90rem] gap-8 lg:gap-12">
            ...
            {/* Left Column - List */}
            <div className="flex-1 w-full text-base md:text-lg lg:text-xl font-light space-y-4 md:space-y-6">
              <p className="whitespace-nowrap">Manufacturing has EPR</p>
              <p className="whitespace-nowrap">Finance has banking infrastructure</p>
              <p className="whitespace-nowrap">Retail has ecommerce platforms</p>
              <p className="whitespace-nowrap">Logistics has global networks.</p>
              <p className="font-bold pt-2 text-xl md:text-2xl lg:text-3xl text-pure-white whitespace-nowrap">
            ...
            <div className="flex-1 w-full flex flex-col items-center justify-center shrink-0">
              <div className="relative w-36 md:w-48 lg:w-56 aspect-square mb-6">
                <Image src="/cirka-c-logo-white white.png" alt="Cirka" fill className="object-contain" />
              </div>
      ...
      <section className="relative w-full h-screen grid grid-cols-1 lg:grid-cols-2 snap-start">
        <div className="bg-pure-white text-charcoal relative flex flex-col justify-center p-12 md:p-24">
          <NetworkBackground className="text-charcoal opacity-10 absolute inset-0 z-0" />

          {/* Decorative Circles */}
          {/* Orange circle: bottom left */}
          <div className="absolute bottom-4 lg:bottom-8 left-28 lg:left-48 w-16 h-16 lg:w-20 lg:h-20 rounded-full bg-cirka-orange z-0"></div>
          {/* Tan/Grey circle: middle right */}
          <div className="absolute top-1/2 right-12 lg:right-24 w-12 h-12 lg:w-16 lg:h-16 rounded-full bg-[#A19B86] z-0 -translate-y-1/2"></div>

          <div className="relative z-10 pointer-events-none">
            <h2 className="text-5xl md:text-6xl font-bold uppercase mb-8 pointer-events-auto">
              Value is lost....
            </h2>
            <p className="text-2xl md:text-3xl mb-12 font-medium pointer-events-auto">
              WHEN RESOURCES, DATA AND PEOPLE REMAIN DISCONNECTED.
            </p>
            <ul className="space-y-4 text-xl md:text-2xl font-light text-gray-500 pointer-events-auto">
              <li>Valuable materials.</li>
              <li>Valuable skills.</li>
              <li>Valuable communities.</li>
              <li>Valuable data.</li>
            </ul>
            <p className="text-4xl md:text-5xl font-black mt-12 uppercase text-charcoal pointer-events-auto">
              DISCONNECTED.
            </p>
          </div>
        </div>

        <div className="bg-charcoal relative flex items-center justify-center p-8 lg:p-16">
          <div className="relative w-full h-full max-h-[80vh] border-[12px] border-pure-white bg-gray-200">
            <Image
            ...
            <div className="absolute top-2/3 -left-8 lg:-left-12 w-16 h-16 lg:w-20 lg:h-20 rounded-full bg-cirka-green z-20 -translate-y-1/2"></div>

            {/* White Outline Logo */}
            <div className="absolute -bottom-20 -right-8 z-20 w-56 h-56 drop-shadow-2xl">
              <Image src="/cirka-c-logo-white white.png" alt="Cirka" fill className="object-contain" />
            </div>
          </div>
        </div>
      ...
      <section className="relative w-full min-h-screen bg-[#F5F5F5] text-charcoal flex flex-col items-center justify-center snap-start overflow-hidden">
        <NetworkBackground className="text-charcoal opacity-10 absolute inset-0 z-0" />

        {/* Header Block */}
        <div className="absolute top-12 md:top-24 z-10 w-full flex justify-center">
        ...
        <div className="relative w-full max-w-6xl aspect-[4/3] md:aspect-[16/9] flex items-center justify-center mt-24">
      ...
      <section className="relative w-full min-h-screen bg-[#F5F5F5] text-charcoal flex flex-col items-center justify-center snap-start p-8 overflow-hidden">
        <NetworkBackground className="text-charcoal opacity-10 absolute inset-0 z-0 pointer-events-none" />

        <div className="relative z-10 bg-[#545454] px-8 md:px-12 py-4 mb-24 shadow-md">
          <h2 className="text-4xl md:text-5xl font-black uppercase text-pure-white text-center tracking-wide">
            How Cirka Works
          </h2>
        </div>

        <div className="flex flex-col md:flex-row items-center md:items-start justify-between w-full max-w-5xl space-y-12 md:space-y-0 relative z-10">
          ...
          <div className="flex flex-col items-center z-10 w-40 relative group md:mt-4">
          ...
          {/* 2. CIRKA */}
          <div className="flex flex-col items-center z-20 w-40 relative group">
      ...
      <section className="relative w-full min-h-screen bg-charcoal text-pure-white flex flex-col items-center justify-center snap-start py-12 px-6 md:p-12 lg:p-16 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 relative min-h-[300px] lg:min-h-[400px] flex items-center justify-center overflow-visible">
            <div className="relative w-[600px] h-[600px] flex items-center justify-center scale-[0.45] sm:scale-[0.55] md:scale-[0.6] lg:scale-[0.65] xl:scale-[0.75] origin-center shrink-0">
      ...
      <section className="relative w-full h-screen grid grid-cols-1 lg:grid-cols-2 snap-start">
        <div className="bg-charcoal relative flex items-center justify-center p-8 lg:p-16">
          <div className="relative w-full h-full max-h-[80vh] border-8 border-pure-white shadow-2xl">
            <Image
      ...
      <section className="relative w-full min-h-screen bg-pure-white text-charcoal flex flex-col items-center justify-start snap-start pt-8 pb-16 px-8">
        ...
        <div className="relative z-10 w-full max-w-7xl flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-8 mt-8">
          ...
          <div className="flex flex-col items-center flex-1 w-full relative z-10">
            <div className="relative w-64 h-64 md:w-80 md:h-80 mb-8">
              ...
              <div className="absolute -left-8 md:-left-12 top-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 md:w-48 md:h-48 rounded-full bg-[#545454] flex items-center justify-center shadow-2xl z-20">
          ...
          <div className="flex flex-col items-center flex-1 w-full relative z-20 lg:-mx-12">
            <div className="relative w-64 h-64 md:w-80 md:h-80 mb-8">
              ...
              {/* Center Left Logo */}
              <div className="absolute -left-4 md:-left-8 top-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 md:w-48 md:h-48 rounded-full bg-[#545454] flex items-center justify-center shadow-2xl z-20">
                <div className="relative w-full h-full scale-[1.25]">
                  <Image src="/cirka-c-logo-white white.png" alt="Cirka" fill className="object-contain" />
                </div>
              </div>
              {/* Center Right Logo */}
              <div className="absolute -right-4 md:-right-8 top-1/2 translate-x-1/2 -translate-y-1/2 w-32 h-32 md:w-48 md:h-48 rounded-full bg-[#545454] flex items-center justify-center shadow-2xl z-20">
                <div className="relative w-full h-full scale-[1.25]">
                  <Image src="/cirka-c-logo-white white.png" alt="Cirka" fill className="object-contain" />
                </div>
              </div>
          ...
          <div className="flex flex-col items-center flex-1 w-full relative z-10">
            <div className="relative w-64 h-64 md:w-80 md:h-80 mb-8">
              ...
              <div className="absolute -right-8 md:-right-12 top-1/2 translate-x-1/2 -translate-y-1/2 w-32 h-32 md:w-48 md:h-48 rounded-full bg-[#545454] flex items-center justify-center shadow-2xl z-20">
                <div className="relative w-full h-full scale-[1.25]">
                  <Image src="/cirka-c-logo-white white.png" alt="Cirka" fill className="object-contain" />
                </div>
              </div>
      ...
      {/* SECTION 9: ECOSYSTEM */}
      <section className="relative w-full h-screen grid grid-cols-1 lg:grid-cols-2 grid-rows-2 lg:grid-rows-1 snap-start bg-charcoal overflow-hidden">
        <NetworkBackground className="text-white opacity-20 absolute inset-0 pointer-events-none" />

        <div className="relative z-10 flex flex-col justify-center items-center p-6 md:p-12 lg:p-24 h-full text-center">
          <h2 className="text-[6vw] md:text-5xl lg:text-6xl font-black uppercase mb-4 md:mb-8 tracking-tight leading-tight shrink-0 whitespace-nowrap">
            We Are Building ......
          </h2>
          <p className="text-[3.5vw] md:text-2xl lg:text-3xl font-bold uppercase mb-8 md:mb-16 shrink-0 whitespace-nowrap">
            Something bigger than a platform.
          </p>

          <ul className="space-y-4 md:space-y-6 lg:space-y-8 text-[3vw] md:text-xl lg:text-2xl font-bold uppercase shrink-0 whitespace-nowrap">
          ...
          <div className="w-16 h-16 md:w-24 md:h-24 lg:w-32 lg:h-32 mt-8 md:mt-12 relative shrink-0">
            <Image src="/cirka-c-logo-white white.png" alt="Cirka" fill className="object-contain" />
          </div>
        </div>

        <div className="relative z-10 flex items-center justify-center p-6 md:p-12 lg:p-16 h-full">
          <div className="relative w-full h-full max-h-[100%] lg:max-h-[80vh] border-[4px] md:border-8 border-pure-white shadow-2xl">
            <Image
      ...
      <section className="relative w-full h-screen snap-start overflow-hidden flex items-center justify-center p-4 md:p-8">
        ...
        <div className="relative z-10 w-full h-full bg-[#545454] border-[8px] md:border-[12px] border-pure-white p-6 md:p-10 lg:p-16 flex flex-col justify-center shadow-2xl">
          ...
          <div className="absolute bottom-6 right-6 md:bottom-10 md:right-10 lg:bottom-16 lg:right-16 w-32 h-32 md:w-48 md:h-48 lg:w-64 lg:h-64 xl:w-[22rem] xl:h-[22rem] pointer-events-none z-0">
            <Image src="/cirka-c-logo-white white.png" alt="Cirka" fill className="object-contain object-right-bottom" />
          </div>

        </div>
      </section>

      {/* SECTION 11: CONTACT / CTA (Exact Clone of Image) */}
      <section className="relative w-full h-screen snap-start flex flex-col overflow-hidden bg-charcoal">

        {/* Top Dark Section */}
        <div className="relative w-full flex-[70] flex flex-col items-center justify-center px-4 md:px-8 overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-5xl flex flex-col items-center text-center mt-8 md:mt-12">

            {/* Logo - Using background-image to crop vertical padding but keep 100% width */}
            <div
              className="w-[85vw] sm:w-[70vw] md:w-[60vw] lg:w-[50vw] max-w-[45rem] h-20 sm:h-24 md:h-32 lg:h-40 xl:h-48 mb-4 md:mb-6 bg-[length:100%_auto] bg-center bg-no-repeat"
              style={{ backgroundImage: "url('/cirka-logo-white.png')" }}
            >
            </div>

            {/* Subheadings - Reduced Size */}
            <h2 className="text-[3vw] md:text-lg lg:text-xl xl:text-2xl font-bold uppercase tracking-wide text-pure-white mb-4 leading-snug">
              CONNECTING SECONDARY RESOURCES,PEOPLE AND DATA.<br />
              CREATING MEASURABLE VALUE.
            </h2>

            <h3 className="text-[2.5vw] md:text-base lg:text-lg xl:text-xl font-bold uppercase tracking-wider text-cirka-orange mb-6 md:mb-10" style={{ WebkitTextStroke: '0.5px #FF5C00' }}>
              HELP BUILD THE MISSING INFRASTRUCTURE.
            </h3>

            {/* Paragraph - Reduced Size */}
            <p className="text-[2vw] md:text-sm lg:text-base xl:text-lg font-medium text-pure-white max-w-4xl leading-relaxed">
        ...
        {/* Bottom White Section - Reduced height with grey bg below it */}
        <div className="relative w-full flex-[30] pb-4 md:pb-8 flex flex-col">
